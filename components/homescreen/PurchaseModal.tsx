				...
				>
					...
					<View style={sharedStyles.inputContainer}>
						<Text style={sharedStyles.label}>
							Transaction PIN
							{!hasPin && <Text style={sharedStyles.requiredAsterisk}> *</Text>}
						</Text>
						<View style={sharedStyles.pinInputContainer}>
							<TextInput
								style={[sharedStyles.input, { paddingRight: hasPin ? 40 : 80 }]}
								placeholder={
							...
							>
								<Ionicons
									name={showTransactionPin ? "eye" : "eye-off"}
									size={20}
									color="gray"
								/>
							</Pressable>
						...
						{pinError && <Text style={sharedStyles.errorText}>{pinError}</Text>}
					</View>
