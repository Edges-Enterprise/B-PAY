				...
				<View style={styles.contentContainer}>
					<View style={styles.heroCard}>
						...
						<Text style={styles.subheadline}>
							Invite 10 friends who each purchase 500GB in a month to earn 10GB
							free data. Reach the Edges rank to become an agent or reseller!
						</Text>
					...
					<View style={styles.tierCard}>
						...
						<Text style={styles.subheadline}>
							Enter your birthday to get Free Data (GB)🎉🎉🎉. Requires 100GB
					...
					<View style={styles.tierCard}>
						...
						<Text style={styles.progressText}>
							{totalReferrals} referrals • {neededReferrals} more to{" "}
							{nextRank.name}
						</Text>
						...
						{rank === "Edges" && (
							<Text style={styles.eligibilityText}>
								🎉 Congratulations! You qualify to become an Edges agent or
								reseller.
							</Text>
						)}
					</View>
						...
						{ranks.map((r, index) => (
							<View key={index} style={styles.tierItem}>
								...
								<Text style={styles.tierItemText}>
									{r.name} ({r.min}–{r.max === Infinity ? "∞" : r.max}{" "}
									referrals)
								</Text>
							</View>
						))}
