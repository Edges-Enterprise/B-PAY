...
// 				} catch (parseError) {
// 					console.error(
// 						`Failed to parse message for notification ${n.id}:`,
// 						parseError,
// 					);
// 					message = "Invalid notification message";
// 				}
...
// 					<Image
// 						source={
// 							typeof logoSource === "string" ? { uri: logoSource } : logoSource
// 						}
// 						style={styles.networkLogo}
// 						resizeMode="contain"
// 					/>
...
// 						</Text>
// 					</View>
// 					{["hot_data", "special_data", "weekend_plan", "weekly_plan"].includes(
// 						item.type,
// 					) && (
// 						<Pressable
...
export default function NotificationsPage() {
	...
	const handleNotificationPress = (notification: Notification) => {
		...
		if (notification.type === "transaction") {
			...
			router.push("/commingsoon"); // Replace with actual update route
		} else if (notification.type === "advertisement") {
			router.push("/commingsoon"); // Replace with actual hot deals route
		}
	};
